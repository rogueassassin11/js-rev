...
// 4.
const arrTakeOut = function (arr) {
  const str = arr.flatMap(dog => dog.owners);

  return str.join(' and ');
};
console.log(`${arrTakeOut(ownersEatTooMuch)}'s dogs eat too much!`);
console.log(`${arrTakeOut(ownersEatTooLittle)}'s dogs eat too little!`);
